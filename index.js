...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // If we got HTML instead of PDF, the redirect went somewhere unexpected
    if (contentType.includes('text/html')) {
      return res.status(422).send('Got HTML instead of PDF — redirect chain may go outside allowlist');
    }
